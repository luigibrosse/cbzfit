...
def test_missing_icc_profile_returns_none() -> None:
    image = Image.new(
        mode="RGB",
        size=(10, 20),
        color="white",
...
def test_embedded_icc_profile_is_returned() -> None:
    image = Image.new(
        mode="RGB",
        size=(10, 20),
        color="white",
...
def test_non_binary_icc_profile_returns_none() -> None:
    image = Image.new(
        mode="RGB",
        size=(10, 20),
        color="white",
...
def test_flatten_transparency_returns_new_image() -> None:
    image = Image.new(
        mode="RGBA",
        size=(10, 20),
        color=(0, 0, 0, 0),
...
def test_cmyk_image_without_profile_is_converted_to_rgb() -> None:
    image = Image.new(
        mode="CMYK",
        size=(10, 20),
        color=(0, 0, 0, 255),
...
def test_cmyk_conversion_falls_back_when_profile_is_invalid() -> None:
    image = Image.new(
        mode="CMYK",
        size=(10, 20),
        color=(0, 0, 0, 255),
...
def test_rgb_image_is_already_compatible_with_jpeg() -> None:
    image = Image.new(
        mode="RGB",
        size=(10, 20),
        color="white",
...
def test_rgba_image_is_already_compatible_with_png() -> None:
    image = Image.new(
        mode="RGBA",
        size=(10, 20),
        color=(255, 0, 0, 128),
...
def test_rgba_image_is_flattened_onto_white_for_jpeg() -> None:
    image = Image.new(
        mode="RGBA",
        size=(3, 1),
    )
...
def test_rgba_image_is_already_compatible_with_webp() -> None:
    image = Image.new(
        mode="RGBA",
        size=(10, 20),
        color=(255, 0, 0, 128),
...
def test_grayscale_image_is_already_compatible_with_jpeg() -> None:
    image = Image.new(
        mode="L",
        size=(10, 20),
        color=128,
...
def test_cmyk_image_is_converted_to_rgb_for_jpeg() -> None:
    image = Image.new(
        mode="CMYK",
        size=(10, 20),
        color=(0, 0, 0, 255),
...
def test_compatible_image_preserves_icc_profile_when_requested() -> None:
    image = Image.new(
        mode="RGB",
        size=(10, 20),
        color="white",
...
def test_compatible_image_omits_icc_profile_when_disabled() -> None:
    image = Image.new(
        mode="RGB",
        size=(10, 20),
        color="white",
...
def test_mode_conversion_does_not_preserve_source_icc_profile() -> None:
    image = Image.new(
        mode="RGBA",
        size=(10, 20),
        color=(255, 0, 0, 128),
...
def test_jpg_alias_is_normalized_for_format_preparation() -> None:
    image = Image.new(
        mode="RGB",
        size=(10, 20),
        color="white",
