...
class TestValidateSourceImage:
    ...
    def test_real_jpeg_image_is_validated(self) -> None:
    ...
    def test_real_png_image_is_validated(self) -> None:
    ...
    def test_real_webp_image_is_validated(self) -> None:
    ...
    def test_missing_detected_format_is_rejected(self) -> None:
        filename = "001.jpg"
        image = Mock(spec=Image.Image)
        image.format = None
        image.is_animated = False
    ...
    def test_supported_extension_can_contain_unsupported_content(self) -> None:
        filename = "001.jpg"
        detected_format = "GIF"
        image = Mock(spec=Image.Image)
        image.format = detected_format
